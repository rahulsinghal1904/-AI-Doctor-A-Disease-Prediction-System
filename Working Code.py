...
# TESTING DATA df -------------------------------------------------------------------------------------
df=pd.read_csv(r"C:\Users\rahul\Desktop\dataset\Training.csv")
...
# TRAINING DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv(r"C:\Users\rahul\Desktop\dataset\Testing.csv")
...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Prediction based on Symptoms provided", fg="black", bg="purple1")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT, text="Machine Learning Project", fg="black", bg="purple1")
...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="black",fg="yellow")
dst.grid(row=15, column=1, pady=10, sticky=W)

rnf = Button(root, text="Randomforest", command=randomforest,bg="black",fg="yellow")
rnf.grid(row=17, column=1, pady=10, sticky=W)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="black",fg="yellow")
